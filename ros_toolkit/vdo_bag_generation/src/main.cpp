...
int main(int argc, char **argv)
{
    ...
    std::string input_video_topic = video_stream_namespace + "image_color";
    std::string camera_info_topic = video_stream_namespace + "camera_info";
    std::string mask_rcnn_topic = "vdoslam/results/maskrcnn";
    std::string flow_net_topic = "vdoslam/results/flownet";
    std::string monodepth_topic = "vdoslam/results/monodepth";
